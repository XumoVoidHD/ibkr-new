...
# Changeable Values
date = "20250127"                   # Date of contract (YYYY-MM-DD)
...
ATM_CALL = 0                        # How far away call position is (2 means that its $10 away from current price)
ATM_PUT = 0                         # How far away put position is (2 means that its $10 away from current price)
call_sl = 25                        # From where the call stop loss should start from (15 here means 15% of entry price)
...
put_sl = 25                         # From where the put stop loss should start from (15 here means 15% of entry price)
...
entry_minute = 50                   # Entry time in minutes
